...
artObjects.set("charcoal_pastel_pencil_still", {
  title: "Symbolic Still life",
  width: 250,
  height: 300,
});
artObjects.set("charcoal_skull_bones", {
  title: "Skull & Bones",
  width: 300,
  height: 250,
});
artObjects.set("color_pencil_marble", {
  title: "Marble",
  width: 250,
  height: 250,
});
artObjects.set("cutest_pup", { title: "Cutest Pup", width: 250, height: 250 });
artObjects.set("figure_drawing", {
