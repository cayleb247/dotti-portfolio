  ...
  return (
    <main>
      <div className={styles.galleryContainer}>
        <h1>Gallery</h1>
        <div className={styles.galleryDesk}>
          <div className={styles.selectedWorks}>
            <div className={styles.worksColumnsRow}>
              <div
                className={`${styles.selectedWorksColumn} ${styles.columnLeft}`}
              >
              ...
              <div
                className={`${styles.selectedWorksColumn} ${styles.columnRight}`}
              >
                <Artwork art_id="color_pencil_marble"></Artwork>
                <Artwork art_id="open_wrapped"></Artwork>
              </div>
            </div>
            <div className={`${styles.selectedWorksRow} ${styles.horizontalArtworks}`}>
        ...
        <p className={styles.hiddenArtText}>Cetain artworks are hidden due to space constraints</p>
      </div>
    </main>
  );
}
